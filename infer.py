...
def infer(eval_loader, opt, model=None, repeat=1):
    ...
    gen_res = []
    # save generate image
    for i, (indices, annids, scids, comp_w, comp_h, bg_img_arrs, fg_img_arrs, fg_msk_arrs, comp_img_arrs, comp_msk_arrs,
            bg_img_feats, fg_img_feats, fg_msk_feats, comp_img_feats, comp_msk_feats, comp_bboxes, labels,
            catnms) in enumerate(tqdm(eval_loader)):
        index, annid, scid, comp_w, comp_h, bg_img_arr, fg_img_arr, fg_msk_arr, comp_img_arr, comp_msk_arr, comp_bbox, label, catnm = \
            indices[0], annids[0], scids[0], comp_w[0], comp_h[0], bg_img_arrs[0], fg_img_arrs[0], fg_msk_arrs[0], \
            comp_img_arrs[0], comp_msk_arrs[0], comp_bboxes[0], labels[0], catnms[0]
        for repeat_id in range(repeat):
            ...
            if repeat == 1:
                gen_file_name = "{}_{}_{}_{}_{}_{}_{}".format(index, annid, scid, gen_comp_bbox[0], gen_comp_bbox[1],
                                                              gen_comp_bbox[2], gen_comp_bbox[3])
            else:
                gen_file_name = "{}_{}_{}_{}_{}_{}_{}_{}".format(index, repeat_id, annid, scid, gen_comp_bbox[0],
                                                                 gen_comp_bbox[1], gen_comp_bbox[2], gen_comp_bbox[3])
